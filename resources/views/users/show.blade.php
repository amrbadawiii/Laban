...
@section('subContent')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white p-4 shadow rounded-lg">
            ...
            <x-key-value label="{{ __('user.user_type') }}" :value="$user['userTypeName']" />
        </div>
        ...
        <div class="bg-white p-4 shadow rounded-lg">
            ...
            <x-key-value label="{{ __('warehouse.created_at') }}" :value="$user['warehouse']['created_at']" />
            <x-key-value label="{{ __('warehouse.updated_at') }}" :value="$user['warehouse']['updated_at']" />
        </div>
    </div>
