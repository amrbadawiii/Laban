    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center {{ app()->getLocale() == 'ar' ? 'sm:mr-6' : 'sm:ml-6' }}">
                <!-- Language Dropdown -->
                <div class="relative">
                    <button id="languageSelector" class="inline-flex items-center px-3 py-2 text-gray-500 dark:text-gray-400">
                        {{ app()->getLocale() === 'en' ? 'English' : 'العربية' }}
                        <svg class="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <div id="languageDropdown" class="hidden absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5">
                        <a href="{{ route('language.set', 'en') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300">English</a>
                        <a href="{{ route('language.set', 'ar') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300">العربية</a>
                    </div>
                </div>
                ...
                <div class="relative ml-4">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center text-gray-500 dark:text-gray-400">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="border-t border-gray-200 dark:border-gray-600">
                <div class="px-4 py-1">
                    ...
                    <div :class="{'block': langOpen, 'hidden': ! langOpen}" class="hidden mt-2 bg-white dark:bg-gray-800 shadow-lg rounded-md py-1 w-full">
                        <a href="{{ route('language.set', 'en') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300">English</a>
                        <a href="{{ route('language.set', 'ar') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300">العربية</a>
                    </div>
                </div>
